 ...
 * @author PC_LENOVO
 */
public class DesconciliacaoPriorizadoDAO implements CrudDAO<Desconciliacao> {
    ...
    public void gerarOrcado(Desconciliacao entidade) throws ErroSistema {
        ...
        try {
            ...
            stmt.setString(7, entidade.getDataDesconciliacao().toString());
            if (entidade.getDiasDesconciliado() <= 10) {
...
//            stmt.setString(14, entidade.getAvocado());
    ...
    public Boolean compararValor(Desconciliacao entidade){
        ...
        if(entidade.getValorDesconciliacao() > 1000000){
