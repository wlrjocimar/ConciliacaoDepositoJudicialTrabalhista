 ...
 * @author PC_LENOVO
 */
public class DesconciliacaoTransferenciaDAO implements CrudDAO<Desconciliacao> {
    ...
    public List<Desconciliacao> buscar() throws ErroSistema {
        try {
            Connection con = ConnectionFactory.conectar("rejud");
            String sql = "SELECT * from rejud.tb_desconciliacao_djo_paj where SITUACAO = 'TRANSFERENCIA'";
